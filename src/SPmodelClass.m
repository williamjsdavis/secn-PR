...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        ...
        function [l,h] = plotAutocorrelation(obj)
            ...
            dAfitIncludingZero = [0;obj.thetaProperties.rMatrixFull*...
                obj.thetaProperties.lambdaStar];
            
            % Make figure
            hold on,box on
            h.scatter = scatter(...
                timeShiftVector,obj.thetaProperties.dA,...
                30,'filled','k');
        ...
        function [l,h] = plotMoment1(obj)
            ...
            timeShiftVector = obj.momentData.observationData.timeStep*...
                timeShiftSamplePoints;
            timeShiftSamplePointsFull = ...
                obj.momentData.observationData.timeStep*...
                (1:max(timeShiftSamplePoints));
            
            [~,timeShiftGrid] = meshgrid(obj.momentData.evalPoints,...
                timeShiftVector);
            [~,timeShiftGridFull] = meshgrid(obj.momentData.evalPoints,...
                timeShiftSamplePointsFull);
            
            moment1ByTimeShift = obj.momentData.moment1Matrix./...
                timeShiftGrid;
            
            M1fit = obj.thetaProperties.rMatrixFull*...
                obj.lambdaProperties.lambda1Star./timeShiftGrid;
            M1fitFull = obj.thetaProperties.rMatrixFull*...
                obj.lambdaProperties.lambda1Star./timeShiftGridFull;
            
            % Make figure
            hold on,box on
            h.scatter = scatter(timeShiftGrid(:),moment1ByTimeShift(:),...
                20,'filled','k');
            h.fit = plot(timeShiftGridFull,M1fitFull,'r-');
        ...
        function [l,h] = plotMoment2(obj)
            ...
            M2fit = obj.thetaProperties.rMatrixFull*...
                obj.lambdaProperties.lambda2Star./timeShiftGrid;
            M2fitFull = obj.thetaProperties.rMatrixFull*...
                obj.lambdaProperties.lambda2Star./timeShiftGridFull;
            
            % Make figure
            hold on,box on
            h.scatter = scatter(timeShiftGrid(:),moment2ByTimeShift(:),...
                20,'filled','k');
            h.fit = plot(timeShiftGridFull,M2fitFull,'r-');
